...
$query = "SELECT seat, status, paid, opened, time FROM invoices WHERE id=:id LIMIT 1";
...
$query = "UPDATE invoices SET status=:newStatus, opened=:newOpened WHERE id=:id";
$stmt = $db->prepare($query);
$stmt->bindParam(":newStatus", $newStatus);
$stmt->bindParam(":newOpened", $newOpened);
$stmt->bindParam(":id", $invoiceID);
